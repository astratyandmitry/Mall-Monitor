    ...
    <div class="header-content">
      ...
      <div class="header-nav">
        <ul class="header-nav-list">
          ...
          @endif
          <li
            class="header-nav-list-item has-dropdown {{ isActive(in_array($active_section, ['placement', 'compare', 'reports']), false) }}">
          ...
          @if ( ! $currentUser->store_id && ! $currentUser->is_readonly)
            <li class="header-nav-list-item has-dropdown {{ isActive($active_section == 'manage', false) }}">
              ...
              <ul class="header-nav-list-item-dropdown">
                ...
                <li
                  class="header-nav-list-item-dropdown-item {{ isActive($active_page == 'manage.cashboxes', false) }}">
                  <a href="{{ route('manage.cashboxes.index') }}" class="header-nav-list-item-dropdown-item-link">
                    Кассы
                  </a>
                </li>
                <li
                  class="header-nav-list-item-dropdown-item {{ isActive($active_page == 'manage.visit_countmax', false) }}">
                ...
                @if ( ! $currentUser->mall_id)
                  ...
                  <li class="header-nav-list-item-dropdown-item is-devider"></li>
                  <li
                    class="header-nav-list-item-dropdown-item {{ isActive($active_page == 'manage.developers', false) }}">
                    <a href="{{ route('manage.developers.index') }}" class="header-nav-list-item-dropdown-item-link">
                      Разработчики
                    </a>
                  </li>
                  <li
                    class="header-nav-list-item-dropdown-item {{ isActive($active_page == 'manage.store_integrations', false) }}">
                  ...
                  <li class="header-nav-list-item-dropdown-item is-devider"></li>
                  <li
                    class="header-nav-list-item-dropdown-item {{ isActive($active_page == 'manage.store_types', false) }}">
