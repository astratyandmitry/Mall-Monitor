...
@section('content')
    <div class="shadow-lg rounded">
        <div class="p-8">
            <h1 class="mb-8">
                <a target="_blank"
                   href="{{ route('report_store.export', ['date_from' => @$_GET['date_from'],'date_to' => @$_GET['date_to'], 'store_id' => @$_GET['store_id']]) }}"
            ...
            @if (count($statistics))
                <div class="statistics">
                    <div class="pb-4 font-bold flex w-full">
                        <div class="pl-4 text-grey-darker w-64">
                            ТРЦ
                        </div>
                    ...
                    @foreach($statistics as $statistic)
                        ...
                        <div class="border-t border-grey-lighter flex w-full py-4 hover:bg-grey-lighter hover:rounded-sm hover:border-transparent">
                            <div class="w-64 text-grey-darkest pl-4">
                                {{ $store->mall->name }}
                            </div>
                    ...
                    <div class="rounded-sm font-bold flex w-full py-4 bg-grey-light">
                        <div class="pl-4 text-grey-darker w-64"></div>
