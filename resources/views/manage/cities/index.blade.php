        ...
        <div class="container">
            <div class="heading-content has-action">
                ...
                <div class="heading-action">
                    <a href="{{ route('manage.cities.create') }}" class="btn heading-action-button is-outlined">
                        Добавить город
                    </a>
                </div>
            </div>
                ...
                <div class="box-content">
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <th nowrap width="240">
                                Страна
                                @include('layouts.includes.table.sorting', ['attribute' => 'country_id'])
                            </th>
                        ...
                        @if (count($entities))
                            @foreach($entities as $entity)
                                <tr>
                                    ...
                                    <td class="is-icons">
                                        <a href="{{ route('manage.cities.edit', $entity) }}" title="Редактировать">
